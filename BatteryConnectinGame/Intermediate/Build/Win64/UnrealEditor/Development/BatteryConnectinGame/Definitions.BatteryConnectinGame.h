#undef BATTERYCONNECTINGAME_API
...
#define UE_PROJECT_NAME BatteryConnectinGame
#define UE_TARGET_NAME BatteryConnectinGameEditor
#define UE_MODULE_NAME "BatteryConnectinGame"
...
#define BATTERYCONNECTINGAME_API DLLEXPORT
